...
export const getInitialRowInfo = (): Record<string, RowInfo> => ({
  ...
  FOURCARD: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: FOURCARD`);
  ...
  FULLHOUSE: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: FULLHOUSE`);
      if (handInput === null) return 0;
  ...
  STRAIGHT: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: STRAIGHT`);
      if (handInput === null) return 0;
  ...
  YACHT: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: YACHT`);
      if (handInput === null) return 0;
  ...
  CHOICE: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: CHOICE`);
      if (handInput === null) return 0;
  ...
  NUMBERS_1: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_1`);
      if (handInput === null) return 0;
  ...
  NUMBERS_2: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_2`);
      if (handInput === null) return 0;
  ...
  NUMBERS_3: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_3`);
      if (handInput === null) return 0;
  ...
  NUMBERS_4: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_4`);
      if (handInput === null) return 0;
  ...
  NUMBERS_5: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_5`);
      if (handInput === null) return 0;
  ...
  NUMBERS_6: {
    getScoreFrom: ({ handInputMap }) => {
      ...
      if (handInput === undefined) throw new Error(`No such hand: NUMBERS_6`);
      if (handInput === null) return 0;
